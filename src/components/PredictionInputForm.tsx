...
export default function PredictionInputForm() {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-screen bg-gradient-to-br from-green-600 to-blue-600 flex items-center justify-center px-4 py-8"
    >
              ...
              {result ? (
                !result.error ? (
                  ...
                  >
                    ...
                    {/* Summary Section */}
                    <motion.div variants={itemVariants} className="bg-gradient-to-r from-green-50 to-green-50 p-5 rounded-xl border border-green-200 shadow-sm">
                      ...
                      <div className="mt-4 grid grid-cols-2 gap-4">
                        ...
                        <motion.div 
                          variants={itemVariants}
                          whileHover={{ y: -2 }}
                          className="bg-white p-4 rounded-lg border border-gray-200 shadow-xs hover:shadow-sm transition-shadow col-span-2"
                        >
                    ...
                    {result.focus_area && (
                      <motion.div variants={itemVariants} className="bg-amber-50 p-4 rounded-lg border border-amber-200">
